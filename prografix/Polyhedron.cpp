...
Polyhedron & Polyhedron::makeEllipsoid ( nat n, double x, double y, double z )
{
    return makeEllipsoid ( n, x, y, z, QRandVector3d() );
}
...
Polyhedron & Polyhedron::makeModel ( nat n, const Cylinder3d & fig )
{
...
Polyhedron & Polyhedron::makeModel ( nat n, const Cone3d & fig )
{
