...
inline Vector2d getPoint ( CCArrRef<Vector2d> & ar, const Vector2d & dir )
{
    nat im = 0;
    double max =  dir * ar[0];
...
// Поиск максимального нарушения ограничений для выбранного решения
        ...
        for ( k = 0; k < line.size(); ++k )
        {
            ...
            const Vector2d p = getPoint ( inner, dir );
...
protected:
    ...
    mutable double max;
    CArrRef<Vector2d> poly;
    Def<Conform2d> (*func) ( CArrRef<Vector2d>, CArrRef<Vector2d> );
public:

    MaxFigureInPolygon ( CArrRef<Vector2d> p,
                         Def<Conform2d> (*f) ( CArrRef<Vector2d>, CArrRef<Vector2d> ) ) : 
                         poly(p), max(0), func(f) {}
};
...
Def<Rhombus2d> maxRhombusInConvexPolygonA ( CArrRef<Vector2d> poly )
{
...
Def<Rhombus2d> maxRhombusInConvexPolygonP ( CArrRef<Vector2d> poly )
{
...
Def<Rhombus2d> maxRhombusInPolygonA ( CArrRef<Vector2d> poly )
{
...
Def<Rhombus2d> maxRhombusInPolygonP ( CArrRef<Vector2d> poly )
{
...
static
bool maxPointsInConvexPolygon ( CArrRef<Vector2d> poly1, CArrRef<Vector2d> poly2, 
...
// Поиск оптимального преобразования
    ...
    if ( ! maxPointsInConvexPolygon ( vert, poly, model, stor, at, area2 ) ) return Def<Parallelogram2d>();
