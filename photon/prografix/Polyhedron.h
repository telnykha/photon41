...
namespace Shev
{
    ...
    public:
        ...
        Polyhedron & makeEllipsoid ( nat n, double x, double y, double z );
        Polyhedron & makeModel ( nat n, const Ellipsoid3d & fig )
        {
            return makeEllipsoid ( n, fig.a, fig.b, fig.c ) *= Conform3d ( fig.spin, fig.o, 1 );
        }
        // Сфера ( r - радиус )
        Polyhedron & makeSphere ( nat n, double r )
        {
            return makeEllipsoid ( n, r, r, r );
        }
        Polyhedron & makeModel ( nat n, const Sphere3d & fig )
        {
            return makeSphere ( n, fig.r ) += fig.o;
        }
        // Цилиндр
        Polyhedron & makeModel ( nat n, const Cylinder3d & fig );
        // Конус
        Polyhedron & makeModel ( nat n, const Cone3d & fig );
