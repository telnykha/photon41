...
void copy ( const Shev::Polyhedron & p1, Poly3gon<Vector3f, Vector3f> & p2 );
void copy ( const Poly3gon<Vector3f, Vector3f> & p1, Shev::Polyhedron & p2 );
...
void copy ( const Shev::Polyhedron & p1, Poly3gon<Vector3d, Vector3d> & p2 );
void copy ( const Poly3gon<Vector3d, Vector3d> & p1, Shev::Polyhedron & p2 );
